...
**Main link:** <https://github.com/kafka-ops/julie>
...
- [[kafka]] — Kafka _(score 36.5)_
- [[redpanda]] — redpanda _(score 29.9)_
- [[kafka_2]] — Kafka _(score 27.6)_
- [[pulsar]] — Pulsar _(score 27.6)_
- [[prometheus]] — prometheus _(score 18.9)_

<!-- TODO: review the auto-suggested links above; remove low-signal ones, add ones P6.3 missed. -->
## Keywords

`#red-panda` `#messaging` `#kafka` `#apache` `#topics` `#topic`
