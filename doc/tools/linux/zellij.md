...
title: Zellij
main_link: 
keywords: [zellij, linux, tools, tmux, configuration, layouts, floating]
status: draft
---
...
- [[lazygit]] — Lazygit _(score 23)_
- [[tools/shell/tmux|tmux]] — Tmux _(score 20)_
- [[tmux_ai]] — Tmux AI _(score 18)_
...
`#zellij` `#linux` `#tools` `#tmux` `#configuration` `#layouts` `#floating`
