...
- **Apollo** (Boutin et al., OSDI 2014) — distributed scheduling for
  large-scale data-parallel jobs at Bing scale.
- **Hydra** — federated/multi-cluster resource manager.
...
- [Microsoft Research publications](https://www.microsoft.com/en-us/research/publications/)
- [Apollo — scalable and coordinated scheduling for cloud-scale computing (OSDI '14)](https://www.usenix.org/conference/osdi14/technical-sessions/presentation/boutin)

## Cross-section see-also

- [[db/distributed/scheduling/google/README|google]] — Google scheduling
  papers.
- [[db/distributed/scheduling/vldb/README|vldb]] — VLDB scheduling papers.
