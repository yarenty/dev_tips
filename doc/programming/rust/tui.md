...
**Main link:** <https://github.com/ratatui-org/ratatui>
...
- This file contains **9 top-level `#` headings** — it likely covers multiple distinct topics. Per plan.md §8 step 3, **split this file** into one article per topic.
