...
**Main link:** <https://github.com/RustAudio/coreaudio-rs>
...
`#audio` `#misc` `#rust` `#programming` `#flac` `#symphonia` `#claxon` `#api`

## TODO

- This file contains **8 top-level `#` headings** — it likely covers multiple distinct topics. Per plan.md §8 step 3, **split this file** into one article per topic.
