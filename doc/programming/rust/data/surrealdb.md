...
> Auto-split from `doc/programming/rust/data/db.md` by `article_split.py`. Heading: **surrealDB**.
...
- [[db/relational/surrealdb|surrealdb]] — SurrealDB _(score 20.9)_
- [[lance_data_format]] — Lance _(score 17.1)_
...
`#surrealdb` `#data` `#rust` `#programming`
