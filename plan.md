...
- [ ] **P6.5** 🟨 IN PROGRESS — Auto-suggest *additional* keywords per article (5-strategy mining: title tokens, neighbour-keyword propagation, URL host, body proper-nouns matched against vault vocab, co-occurrence implications). Auto-apply high-confidence suggestions; emit the rest as a review doc.
